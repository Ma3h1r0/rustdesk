...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "仅当 Yemao 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持  后台服务"),
        ...
        ("Black Screen", "黑屏"),
        ("Enable Black Screen", "启用黑屏"),
        ("Disable Black Screen", "禁用黑屏"),
        ("Screen locked. Only remote control allowed.", "屏幕已锁定。仅允许远程控制。"),
        ("Lock Screen", "锁定屏幕"),
        ("Show Screen", "显示屏幕"),
        ("Screen Control", "屏幕控制"),
    ].iter().cloned().collect();
