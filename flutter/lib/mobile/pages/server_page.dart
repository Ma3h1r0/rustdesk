...
// 添加黑屏控制器
class BlackScreenController extends GetxController {
  RxBool isBlackScreenActive = false.obs;
...
class _ServerPageState extends State<ServerPage> {
  ...
  Widget buildScreenControlButtons() {
    return PaddingCard(
      title: translate("Screen Control"),
      child: Column(
          ...
          Row(
            ...
            children: [
              ElevatedButton.icon(
                ...
                label: Text(translate("Lock Screen")),
                onPressed: () {
                  // 锁定屏幕，禁用触摸输入
                  bind.sessionLockScreen();
                  showToast(translate("Screen locked. Only remote control allowed."));
                },
              ...
              Obx(() => ElevatedButton.icon(
                    icon: Icon(blackScreenController.isBlackScreenActive.value 
                        ? Icons.visibility 
                        : Icons.visibility_off),
                    label: Text(blackScreenController.isBlackScreenActive.value 
                        ? translate("Show Screen") 
                        : translate("Black Screen")),
                    onPressed: () {
                      blackScreenController.toggleBlackScreen();
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: blackScreenController.isBlackScreenActive.value 
                          ? Colors.green 
                          : Colors.red,
                    ),
                  )),
